...
var messages = map[Lang]map[string]string{
	FR: {
		...
		"menu_models_nvidia":   "5. NVIDIA -- Modeles gratuits (build.nvidia.com)",
		"menu_quit":            "0. Quitter",
		"menu_choice":          "Choix : ",
		"menu_invalid":         "Choix invalide. Options : 1-5, 0 pour quitter",
		...
		"registry_checksum_error":    "Erreur SHA256 pour le profil %s : installation refusee.",
	...
	EN: {
		...
		"menu_models_nvidia":   "5. NVIDIA -- Free models (build.nvidia.com)",
		"menu_quit":            "0. Quit",
		"menu_choice":          "Choice : ",
		"menu_invalid":         "Invalid choice. Options: 1-5, 0 to quit",
		...
		"registry_checksum_error":    "SHA256 error for profile %s: installation refused.",
